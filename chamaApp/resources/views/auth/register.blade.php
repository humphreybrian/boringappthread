            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <!-- Added the phone field -->
                        <div class="form-group row">
                            <label for="phone" class="col-sm-4 col-form-label text-md-right">{{ __('Phone Number') }}</label>

                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ old('phone') }}" required autofocus placeholder="0722000000">
                        ...
                        <div class="form-group row">
                            <label for="group_id" class="col-sm-4 col-form-label text-md-right">{{ __('Group') }}</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="group_id" class="form-control" name="group_id" required>
                                    ...
                                    <option value="1">Chama Group 1</option>
                                    <option value="2">Chaa group 2</option>
                                    <option value="3">Chaa group 3</option>
                                </select>
                            </div>
                        </div>
